...
//       },
//       redirect_urls: {
//         return_url: `http://localhost:8100/pago-exitoso`, // URL del frontend
//         cancel_url: `http://localhost:8100/pago-cancelado`, // URL del frontend
//       },
//       transactions: [{
//         item_list: { items },
//         amount: {
...
//         return res.status(500).json({ msg: 'Error al crear la transacción de PayPal', details: error });
//       }
